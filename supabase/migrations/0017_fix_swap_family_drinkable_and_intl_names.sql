-- ---------------------------------------------------------------------------
-- Bugfix ronde 4: OFF's brede "en:dairy-desserts"-tag dekt óók drinkyoghurt
-- (drinkbaar!), waardoor die als "spoonable"/dessert_cup werd geclassificeerd
-- i.p.v. uitgesloten te worden zoals bij de losse yoghurt-regel al gebeurde.
-- Zelfde drink-uitsluiting nu ook op de dairy_desserts-tak. Daarnaast een
-- paar internationale schrijfwijzen toegevoegd (yaourt/yogur/joghurt) zodat
-- niet-Nederlandse/Engelse productnamen ook herkend worden -- dekt niet elke
-- taal, maar pakt een aantal veelvoorkomende NULL-gevallen alsnog op.
-- ---------------------------------------------------------------------------
