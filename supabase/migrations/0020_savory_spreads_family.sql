-- ---------------------------------------------------------------------------
-- Nieuwe swap_family "savory_spreads" (smeerkaas, roomkaas smeerbaar) --
-- deze viel voorheen (soms) onder de generieke kaas-regel (cheese_block),
-- terwijl het qua vorm een smeersel is, geen blok/plak kaas. Nodig voor de
-- nieuwe "Andere opties"-groep (bv. chocopasta -> smeerkaas als alternatief
-- met betere waarden, zelfde smeerbare vorm).
-- ---------------------------------------------------------------------------
insert into public.feature_vocabulary (field, value) values
  ('swap_family','savory_spreads')
