-- ---------------------------------------------------------------------------
-- Nieuwe swap_family "soups" -- soep werd voorheen als fresh_vegetables/
-- fresh_fruit geclassificeerd zodra de groente-/fruitnaam in de soepnaam
-- voorkwam (bv. "Tomaten Soep", "Stevige erwtensoep"). Vorm/consumptiewijze
-- van soep (lepelbaar, uit een kom/blik) is echt anders dan een vers stuk
-- groente/fruit, dus verdient een eigen categorie. Check loopt vóór de
-- groente/fruit-regels zodat soep die voorrang krijgt.
-- ---------------------------------------------------------------------------
